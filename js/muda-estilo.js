/**
 * Created by Thiago Cunha on 25/09/2016.
 */
...
function contrateFundoPreto() {
    document.getElementById("acessibilidade").style.color = "rgb(245,245,245)";
    document.getElementById("acessibilidade").style.backgroundColor = "rgb(0,0,0)";
}